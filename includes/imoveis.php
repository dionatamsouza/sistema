  ...
  ?>
            ...
            <div class="col-lg-3">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <a href="/incluir-avaliacao-e-pericia?id=<?php echo $omsid; ?>" class="btn btn-light btn-user btn-block">Avaliação e Perícia</a>
                  <a href="/incluir-auto-de-vistoria?id=<?php echo $omsid; ?>" class="btn btn-light btn-user btn-block">Auto de vistoria</a>
                  <a href="/incluir-copia-do-documento-do-imovel?id=<?php echo $omsid; ?>" class="btn btn-light btn-user btn-block">Cópia do documento do imóvel</a>
                  <a href="/incluir-copia-do-documento-do-proprietario?id=<?php echo $omsid; ?>" class="btn btn-light btn-user btn-block">Cópia do documento do proprietário</a>
                  <a href="/incluir-contrato-de-administracao?id=<?php echo $omsid; ?>" class="btn btn-light btn-user btn-block">Contrato de administração</a>
                </div>
              </div>
            </div>
  <?php
